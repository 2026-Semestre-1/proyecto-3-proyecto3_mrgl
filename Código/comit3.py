...
class Entrenador(Persona):
    def __init__(self, nombre,apellido,fecha_nacimiento,nacionalidad,licencia,experiencia_años,sistemadejuego):
        self.nombre=nombre
        self.apellido=apellido
        self.fecha_nacimiento=fecha_nacimiento
        self.nacionalidad=nacionalidad
        ...
        elif not isinstance(experiencia_años,int):
            return "Error:debe de ser en formato numerico"
        elif not isinstance(sistemadejuego,str):
            return "Error:debe de ser en formato de letras"
    def mostrar_datos(self):
        print(f"""
            Nombre del entrenador:{self.nombre}
            licencia:{self.licencia}
            Años de experencia:{self.experiencia_años}
            Sistema de juego:{self.sistemadejuego}
""")
    def actualizar_datos(self):
        print("")  
